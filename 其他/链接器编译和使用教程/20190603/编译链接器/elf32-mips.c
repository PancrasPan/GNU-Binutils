...
static reloc_howto_type elf_mips_howto_table_rel[] =
{
  ...
  HOWTO (R_MIPS_32,		/* type */ //ppp
	 ...
	 _bfd_mips_elf_generic_reloc, /* special_function */
	 "R_MIPS_32",		/* name */
	 TRUE,			/* partial_inplace ; REL or RELA*/
	 0xffffffff,		/* src_mask */
	 0xffffffff,		/* dst_mask */
	 FALSE),		/* pcrel_offset */
  ...
  HOWTO (R_MIPS_PC21_S2,	/* type *///ppp
	 ...
	 _bfd_mips_elf_generic_reloc, /* special_function */
	 "R_MIPS_PC21_S2",	/* name */
	 TRUE,			/* partial_inplace ;1:REL,0:RELA src_mask must be 0*/
	 0x001fffe0,		/* src_mask */
	 //0x00000000,		/* src_mask */
	 0x001fffe0,		/* dst_mask */
	 TRUE),			/* pcrel_offset */
