; ModuleID = './testcase_4slots/global_fir.c'
...
while.body3:                                      ; preds = %while.cond1
  ...
  %arrayidx = getelementptr inbounds [16 x i32]* @h, i32 0, i32 %4
  ...
  %arrayidx6 = getelementptr inbounds [16 x i32]* @y, i32 0, i32 %9
...
while.end:                                        ; preds = %while.cond1
  ...
  %arrayidx7 = getelementptr inbounds [16 x i32]* @y, i32 0, i32 %12
  %13 = load i32* %arrayidx7, align 4
  %14 = load i32* %accum, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx12 = getelementptr inbounds [16 x i32]* @x, i32 0, i32 %20
  ...
  %arrayidx18 = getelementptr inbounds [16 x i32]* @w, i32 0, i32 %26
