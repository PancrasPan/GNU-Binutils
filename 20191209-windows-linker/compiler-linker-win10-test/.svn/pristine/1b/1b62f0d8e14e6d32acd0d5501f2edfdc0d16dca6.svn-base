; ModuleID = '.\HWlooptest\succ\loopmain.c'
...
for.body:                                         ; preds = %for.body.for.body_crit_edge, %entry
  %1 = phi i32 [ 1, %entry ], [ %.pre, %for.body.for.body_crit_edge ]
  %2 = phi i32 [ 1, %entry ], [ %add, %for.body.for.body_crit_edge ]
...
for.end15:                                        ; preds = %for.body9
  %call = call i32 @add(i32* %arrayidx1, i32 100) #3
