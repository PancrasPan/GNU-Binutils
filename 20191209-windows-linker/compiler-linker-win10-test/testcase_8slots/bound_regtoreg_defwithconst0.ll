; ModuleID = '.\HWlooptest\succ\bound_regtoreg_defwithconst.c'
target datalayout = "e-m:m-p:32:32-i8:8:32-i16:16:32-i64:64-n32-S64"
target triple = "dsp"

@lowerbound = global i32 0, align 4
@upperbound = global i32 256, align 4
...
entry:
  ...
  %1 = load i32* @upperbound, align 4, !tbaa !1
...
for.end:                                          ; preds = %entry, %for.cond.for.end_crit_edge
  %3 = phi i32 [ %add, %for.cond.for.end_crit_edge ], [ %sum.promoted, %entry ]
  ret i32 %3
}
