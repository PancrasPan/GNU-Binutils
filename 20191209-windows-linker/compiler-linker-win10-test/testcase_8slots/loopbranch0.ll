; ModuleID = '.\HWlooptest\succ\loopbranch.c'
...
for.body:                                         ; preds = %entry, %for.inc
  %i.022 = phi i32 [ %add9, %for.inc ], [ 1, %entry ]
  %sum.021 = phi i32 [ %sum.1, %for.inc ], [ 0, %entry ]
