; ModuleID = './testcase_8slots/referenceIndOut.c'
...
for.cond.for.end_crit_edge:                       ; preds = %for.body
  ...
  %4 = select i1 %2, i32 %.op.op.op.op, i32 3
  br label %for.end

for.end:                                          ; preds = %for.cond.for.end_crit_edge, %entry
  %i.0.lcssa = phi i32 [ %4, %for.cond.for.end_crit_edge ], [ 0, %entry ]
