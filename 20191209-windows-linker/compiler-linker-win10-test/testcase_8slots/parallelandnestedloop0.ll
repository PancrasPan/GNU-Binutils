; ModuleID = '.\HWlooptest\succ\parallelandnestedloop.c'
...
for.cond1.preheader:                              ; preds = %for.inc7, %entry
  ...
  br i1 %cmp220, label %for.body3.lr.ph, label %while.body.lr.ph

for.body3.lr.ph:                                  ; preds = %for.cond1.preheader
  %.pre = load i32* @sum, align 4, !tbaa !1
  br label %for.body3

do.cond.preheader:                                ; preds = %for.inc7
  %0 = load i32* @bound, align 4, !tbaa !1
  %1 = icmp slt i32 %0, 255
  %.op = add i32 %0, 1
  %2 = select i1 %1, i32 256, i32 %.op
...
for.body3:                                        ; preds = %for.body3.lr.ph, %for.body3
  %4 = phi i32 [ %.pre, %for.body3.lr.ph ], [ %add, %for.body3 ]
  %j.021 = phi i32 [ %half.025, %for.body3.lr.ph ], [ %sub, %for.body3 ]
  %arrayidx = getelementptr inbounds i32* %p_array, i32 %j.021
  %5 = load i32* %arrayidx, align 4, !tbaa !1
  %add = add nsw i32 %4, %5
...
while.body:                                       ; preds = %while.body, %while.body.lr.ph
  ...
  %6 = load i32* %arrayidx5, align 4, !tbaa !1
  %sub6 = sub nsw i32 %sub624, %6
...
for.inc7:                                         ; preds = %while.cond.for.inc7_crit_edge, %while.cond.preheader
  ...
  br i1 %exitcond27, label %do.cond.preheader, label %for.cond1.preheader
}
