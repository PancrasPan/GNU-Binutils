...
#CLANG_PARAMETER = ['-S', '--target=dsp', '-emit-llvm']
#CLANG_PARAMETER = ['-S', '--target=dsp', '-emit-llvm','-I','./include']
CLANG_PARAMETER = ['-S', '-v','--target=dsp', '-emit-llvm','-I','./include']
#'-debug-only=dsp-analyze-imm','-debug-only=dsp-asm-printer' ,'-nopack', '-disable-dsp-hwloops','-debug','-debug-pass=Structure'
#LLC_PARAMETER = ['-march=dsp', '-mcpu=dspse', '-relocation-model=static','-nopack','-disable-dsp-hwloops' ]
#LLC_PARAMETER = ['-march=dsp', '-mcpu=dspse', '-relocation-model=static', '-disable-dsp-hwloops','-view-legalize-dags']
LLC_PARAMETER = ['-march=dsp', '-O1','-mcpu=dspse', '-disable-dsp-hwloops','-relocation-model=static']
